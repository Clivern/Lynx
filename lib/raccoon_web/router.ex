...
defmodule RaccoonWeb.Router do
  use RaccoonWeb, :router

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, {RaccoonWeb.LayoutView, :root}
    plug :protect_from_forgery
    plug :put_secure_browser_headers
    plug Raccoon.Middleware.Logger
    plug Raccoon.Middleware.UIAuthMiddleware
  end

  pipeline :api do
    plug :accepts, ["json"]
    plug Raccoon.Middleware.Logger
    plug Raccoon.Middleware.APIAuthMiddleware
  end
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      ...
      live_dashboard "/dashboard", metrics: RaccoonWeb.Telemetry
    end
  end
