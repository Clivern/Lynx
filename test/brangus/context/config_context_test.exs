...
defmodule Brangus.Context.ConfigContextTest do
  @moduledoc """
  Lock Context Test Cases
  """
  use Brangus.DataCase
  alias Brangus.Context.ConfigContext, as: ConfigContext
